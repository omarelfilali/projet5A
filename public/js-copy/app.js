...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var butons = document.querySelectorAll('.menu-naviguation>div');
  var table_dashboard_proj = document.querySelector(".table_dashboard_proj");

  if (butons != null) {
    var container_relindus = document.querySelector('.container_relindus');
    var container_propos = document.querySelector('.container_propos');
    butons.forEach(function (buton) {
      buton.addEventListener('click', function (e) {
        if (!e.target.parentNode.classList.contains("ongletActif")) {
          butons.forEach(function (buton_class) {
          ...
          } else if (e.target.id == "propos_proj") {
  ...
  if (table_dashboard_proj != null) {
    var _butons = document.querySelectorAll('.button-list');

    var tabs = document.querySelectorAll('.deroulant');

    _butons.forEach(function (buton) {
      buton.addEventListener('click', function (e) {
        e.currentTarget.parentNode.parentNode.childNodes.forEach(function (child) {
          if (child.classList) {
            if (child.classList.contains('list-new-options')) {
              child.classList.toggle('list-new-options-open');
            }

            if (child.classList.contains('list-new-options-open')) {
              tabs.forEach(function (tab) {
                tab.addEventListener('mouseleave', function (e) {
                  if (e.currentTarget) {
                    child.classList.remove('list-new-options-open');
                  }
                });
              });
            }
    ...
    var main_check = document.querySelector('.main_check');
    var all_check = document.querySelectorAll('.checkbox_dashboard');
    main_check.addEventListener('change', function (e) {
      all_check.forEach(function (check) {
    ...
    var filtre_panel = document.querySelector('.filtre-panel');

    if (filtre_panel) {
      var buton_filtre = document.querySelector('.filter_dashboard');
      buton_filtre.addEventListener('click', function () {
        filtre_panel.classList.toggle('dispblock');
      });
      document.querySelector('.croix_filtre').addEventListener('click', function () {
        console.log('coucou');
