...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'cas.univ-lemans.fr'),
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'cas.univ-lemans.fr'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://cas.univ-lemans.fr/cas/logout'),
