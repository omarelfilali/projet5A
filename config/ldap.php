            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'ldap.univ-lemans.fr')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'ou=people,dc=univ-lemans,dc=fr'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'cn=extadm,dc=univ-lemans,dc=fr'),
                'password' => env('LDAP_PASSWORD', 'ldp819RO'),
