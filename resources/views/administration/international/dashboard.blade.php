        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  ...
                  <p>des 5A avec une expérience validée</p>
                </div>
                <div class="icon">
          ...
          <div class="row">
            ...
            <section class="col-lg-5 connectedSortable">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Dernières demandes de séjours</h3>

                        <div class="card-tools">
                            <span class="badge badge-danger">8 nouveaux séjours</span>
                    ...
                    <div class="card-footer text-center">
                        <a href="javascript:">Voir tous les Séjours</a>
                    </div>
                    <!-- /.card-footer -->
                </div>
