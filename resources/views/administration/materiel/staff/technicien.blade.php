...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">Matériel - Techniciens</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
...
<section class="content">
		<div class="container-fluid">
			<div class="card card-success">
				<form method="POST" action={{ route('administration.materiel.staff.techniciens.add') }}>
					{{ method_field('PUT')}}
					@csrf
					<div class="card-header with-border">
					<h3 class="card-title">{{ __('msg.add_technician') }}</h3>
					</div>
					<div class="card-body">
					<div class="row">
						<div class="col-md-12">
						<div class="form-group @error('personnel_id') has-error @enderror">
							<label>{{ __('msg.technician_name') }}</label>
						...
						<div class="col-md-12">
							...
							<button type="submit" class="btn btn-success">{{ __('msg.add_technician') }}</button>
							</div>
						</div>
					</div>
					</div>
			...
			<div class="card card-primary">
				<div class="card-header with-border">
				<h3 class="card-title">{{ trans_choice('msg.technician', 2) }}</h3>
				</div>
					...
					<table class="table table-hover">
						...
						<tr>
							...
							<td>
								<form method="POST" action={{ route('administration.materiel.staff.techniciens.delete', ['id' => $t->id]) }}>
									{{ method_field('DELETE')}}
									@csrf
